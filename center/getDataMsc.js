$(document).ready(function() {
    ...
    $.ajax({
        type: "get",
        url: "http://115.28.17.113/vote/index.php/Index/get_C_data",
    ...
    function cloneAndSetValue(msg) {
        var colorList = ['#5e0000', '#190066', '#ac7906', '#114160', '#2ea44e', '#1d7800','#8f0477','#959707','#0a8c81','#f73f06','#068e83','#0c8303'];
